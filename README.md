SpringBank is a banking application built with Spring Boot, offering basic functionalities such as account creation, deposit, withdrawal, and transaction history.
